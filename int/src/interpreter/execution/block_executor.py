...
@brief Block execution is implemented.
@author Hana Liškařová xliskah00

DOXYGEN COMMENTS WERE AI GENERATED AND PROOFREAD BY ME

A block is executed here as a sequence of assignments.
The right-hand side of each assignment is evaluated by the
...
class BlockExecutor:
    ...
    def __init__(self, expression_dispatcher: ExpressionDispatcher) -> None:
        """
        @brief Required execution dependency is stored.
    ...
    def execute(
        ...
        @param block_ast A block AST whose assignments are executed.
        ...
        @return The value of the last evaluated assignment expression,
                or nil for an empty block.
        """

        last_value: RuntimeValue | None = None

        # block result = value of last assignment
    ...
    def execute_assignment(
        ...
        # updates an existing binding or defines a new local one
